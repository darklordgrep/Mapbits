...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(43420568419713281)
...
'Module   : Mapbits 5 - Legend Entry',
'Location : $Id: item_type_plugin_mil_army_usace_mapbits_legend_entry.sql 21386 2026-02-10 20:05:51Z b2eddjw9 $',
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43420955520713281)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
...
,p_help_text=>'A Lodestar, ArcGIS REST, WMS, or Georaster item to associate with this entry. If set, the entry''s default appearance will derive from the layer''s settings, and features like toggling the layer will be available.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43421340361713281)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43421763264713282)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43422113821713282)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43422538842713282)
,p_plugin_attribute_id=>wwv_flow_imp.id(43422113821713282)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43423008852713282)
,p_plugin_attribute_id=>wwv_flow_imp.id(43422113821713282)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43423588270713282)
,p_plugin_attribute_id=>wwv_flow_imp.id(43422113821713282)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43424064878713282)
,p_plugin_attribute_id=>wwv_flow_imp.id(43422113821713282)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43424547657713282)
,p_plugin_attribute_id=>wwv_flow_imp.id(43422113821713282)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43425052377713283)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43425431609713283)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43425951113713283)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43426412927713283)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43426926254713283)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43427438324713283)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43427951149713284)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43428461519713284)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43428999523713284)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(43429454278713284)
,p_plugin_attribute_id=>wwv_flow_imp.id(43425052377713283)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43429914796713284)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(43425052377713283)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'icon_class'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43430366039713284)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43430784260713284)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(43431785007713286)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(43432193619713286)
,p_plugin_id=>wwv_flow_imp.id(43420568419713281)
