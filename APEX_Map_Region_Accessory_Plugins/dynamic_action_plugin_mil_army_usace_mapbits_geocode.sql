...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(43241307783713183)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43241724350713183)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43242152211713183)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43242515457713183)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43242991873713183)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43243316925713184)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43243707563713184)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(43244172710713184)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(43244583401713185)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(43244973521713185)
,p_plugin_id=>wwv_flow_imp.id(43241307783713183)
